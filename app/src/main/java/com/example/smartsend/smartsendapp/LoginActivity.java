...
// recreate the new Bitmap
    ...
    private void checkRiderLogin(final String email, final String password) {
        ...
        String serverAddress = serverUrl+"/rest_controller/check_rider/"+eEmail+"/"+ePassword;
        showDialog();
    ...
    private void checkClientLogin(final String email, final String password) {
        ...
        String serverAddress = serverUrl+"/rest_controller/check_client/"+eEmail+"/"+ePassword;
